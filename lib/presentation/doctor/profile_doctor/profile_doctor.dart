          ...
          child: Column(
            ...
            children: [
              ...
              _buildSection(
                ...
                themeData: themeData,
                children: [
                  _buildInfoCard('Especialidad', doctor.specialization),
                  _buildInfoCard('Colegio Médico', doctor.medicalCollege),
                  _buildInfoCard(
                    'Años de Experiencia',
          ...
          children: [
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    '${person.names} ${person.firstLastName}',
